...
public class ExcashierV3TradeInfo {
    ...
    private List<ExcashierV3GoodsDetailReq> goodsDetail;
    ...
    public List<ExcashierV3GoodsDetailReq> getGoodsDetail() {
        return goodsDetail;
    }

    public void setGoodsDetail(List<ExcashierV3GoodsDetailReq> goodsDetail) {
